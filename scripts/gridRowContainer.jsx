...
var GridRowContainer = createReactClass({
  ...
  verifyProps: function() {
    if (this.props.columnSettings === null) {
      console.error(
        "gridRowContainer: The columnSettings prop is null and it shouldn't be"
      );
    }
  },
  render: function() {
    ...
    arr.push(
      <this.props.rowSettings.rowComponent
        ...
        data={
          this.props.rowSettings.isCustom
            ? pick(this.props.data, columns)
            : this.props.data
        }
    ...
    if (that.state.showChildren) {
      children =
        that.props.hasChildren &&
        this.props.data["children"].map(function(row, index) {
                ...
                >
                  <Griddle
                    ...
                    parentRowExpandedClassName={
                      that.props.parentRowExpandedClassName
                    }
                    parentRowCollapsedClassName={
                      that.props.parentRowCollapsedClassName
                    }
    ...
    return that.props.hasChildren === false ? (
      arr[0]
    ) : (
