...
describe("Griddle", function() {
  ...
  beforeEach(function() {
    ...
    grid = TestUtils.renderIntoDocument(
      <Griddle results={fakeData} gridClassName="test" />
    );
  });
  ...
  it("sets the max page when the results property is updated", function() {
    ...
    const gridLocal = TestUtils.renderIntoDocument(
      <Griddle results={shortFakeData} gridClassName="test" />
    );
  ...
  it("uses custom row component when set", function() {
    var grid2 = TestUtils.renderIntoDocument(
      <Griddle
        ...
        customRowComponent={SomeCustomComponent}
      />
    );
  ...
  it("should throw an error if useCustomRowComponent is true and no component is added", function() {
    var grid2 = TestUtils.renderIntoDocument(
      <Griddle results={fakeData} useCustomRowComponent={true} />
    );
  ...
  it("should throw an error if useCustomFilterer is true and no filterer is added", function() {
    var grid2 = TestUtils.renderIntoDocument(
      <Griddle results={fakeData} useCustomFilterer={true} />
    );
  ...
  it("should throw an error if useCustomFilterComponent is true and no customFilterComponent is added", function() {
    var grid2 = TestUtils.renderIntoDocument(
      <Griddle results={fakeData} useCustomFilterComponent={true} />
    );
  ...
  it("uses custom grid component when set", function() {
    var grid2 = TestUtils.renderIntoDocument(
      <Griddle
        ...
        customGridComponent={SomeCustomComponent}
      />
    );
  ...
  it("should throw an error if useCustomGridComponent is true and no component is added", function() {
    var grid2 = TestUtils.renderIntoDocument(
      <Griddle results={fakeData} useCustomGridComponent={true} />
    );
    expect(console.error).toHaveBeenCalledWith(
  ...
  it("should display a warning if useCustomGridComponent and useCustomRowComponent are both true", function() {
    ...
    var grid2 = TestUtils.renderIntoDocument(
      <Griddle
        results={fakeData}
        useCustomGridComponent={true}
        customGridComponent={mock}
        useCustomRowComponent={true}
        customRowComponent={mock}
      />
    );
  ...
  it("should not show filter when useCustomGridComponent is true", function() {
    var grid2 = TestUtils.renderIntoDocument(
      <Griddle
        externalResults={fakeData}
        useCustomGridComponent={true}
        customGridComponent={CustomGridComponent}
        gridClassName="test"
      />
    );
  ...
  it("should give the grid the entire dataset and not use the filtered data", function() {
    ...
    var component = TestUtils.scryRenderedComponentsWithType(
      grid2,
      CustomGridComponent
    );
  ...
  it("throws error if useCustomGridComponent and useCustomRowComponent are both true", function() {
    var grid2 = TestUtils.renderIntoDocument(
      <Griddle
        ...
        customGridComponent={CustomGridComponent}
        useCustomRowComponent={true}
        customRowComponent={CustomGridComponent}
      />
    );
    expect(console.error).toHaveBeenCalledWith(
      "Cannot currently use both customGridComponent and customRowComponent."
  ...
  it("renders gridNoData with no data", function() {
    var emptyGrid = TestUtils.renderIntoDocument(
      <Griddle results={[]} gridClassName="test" />
    );
    ...
    expect(
      ReactDOM.findDOMNode(emptyGrid).innerHTML.indexOf("no data") > -1
    ).toEqual(true);
  });

  it('renders grid with no data when "allowEmptyGrid" == true', function() {
    var emptyGrid = TestUtils.renderIntoDocument(
      <Griddle results={[]} gridClassName="test" allowEmptyGrid={true} />
    );
    expect(
      ReactDOM.findDOMNode(emptyGrid).innerHTML.indexOf("<table") > -1
    ).toEqual(true);
  });
});
